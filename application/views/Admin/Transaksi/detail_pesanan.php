					...
					<div class="card-body m-sm-3 m-md-5">
						...
						<div class="row mb-4">
							...
							<div class="col-md-6 text-md-right">
								...
								<strong>
									Alamat Pengiriman<span><?= $detail['transaksi']->alamat ?> Provinsi <?= $detail['transaksi']->provinsi ?> Kota <?= $detail['transaksi']->kota ?> Expedisi. <?= $detail['transaksi']->expedisi ?>, <?= $detail['transaksi']->estimasi ?></span>
								</strong>
						...
						<table class="table table-sm">
							...
							<tbody>
								...
								<tr>
									...
									<th>&nbsp;</th>
									<th>Subtotal </th>
									<th class="text-right">Rp. <?= number_format($detail['transaksi']->grand_total)  ?></th>
								</tr>
								<tr>
									<th>&nbsp;</th>
									<th>&nbsp;</th>
									<th>&nbsp;</th>
									<th>Shipping </th>
									<th class="text-right">Rp. <?= number_format($detail['transaksi']->total_bayar - $detail['transaksi']->grand_total)  ?></th>
								</tr>
								<tr>
									<th>&nbsp;</th>
									<th>&nbsp;</th>
